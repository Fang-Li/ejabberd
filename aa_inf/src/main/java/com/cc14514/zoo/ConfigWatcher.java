...
public class ConfigWatcher extends Config implements Watcher {
	...
	public ConfigWatcher(String host,String basePath) throws IOException, InterruptedException, KeeperException {
...
//		}
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * sms.password=142753
		 */
		ConfigWatcher app1 = new ConfigWatcher("127.0.0.1:2181","/emsg-node");
		app1.store.write(app1.getBasePath()+"/emsg@localhost", "127.0.0.1:4222");
		logger.info("app1 publicConfig : "+app1.publicConfig);

		ConfigWatcher app2 = new ConfigWatcher("127.0.0.1:2181","/emsg-domain");
		app2.store.write(app2.getBasePath()+"/test.com", "emsg@localhost");
		logger.info("app2 publicConfig : "+app2.publicConfig);
